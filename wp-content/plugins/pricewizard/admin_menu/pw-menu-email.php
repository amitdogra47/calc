<?php
	...
	$pageheading = "Price Wizard - Email Info";

	//This is Step3: enter the details for this tab
	// be sure to make the default tab the first in the list
	$headings=array(
		"Prospect"=>"pw-menu-email-prospect.php",
		"Admin"=>"pw-menu-email-admin.php",
		"Domain check"=>"pw-menu-email-domainchk.php",
		"Test/Debug"=>"pw-menu-email-debug.php",
	);
