<?php
	...
	$pageheading = "Wizard - Standard Diary Info";

	//This is Step3: enter the details for this tab
	// be sure to make the default tab the first in the list
	$headings=array(
		"Prices"=>"pw-menu-standarddiaries-prices.php",
		"Custom Pages"=>"pw-menu-standarddiaries-prices-custompages.php", 
		"Date Entries"=>"pw-menu-standarddiaries-prices-dateentries.php",
		"Qty Breaks"=>"pw-menu-standarddiaries-qtybreaks.php",		
	);
