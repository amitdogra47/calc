<?php
	...
	$pageheading = "Price Wizard - Update Custom Diaries";

	//This is Step3: enter the details for this tab
	// be sure to make the default tab the first in the list
	$headings=array(
		"Prices"=>"pw-menu-customdiaries-prices.php",
		"Qty Breaks"=>"pw-menu-customdiaries-breaks.php", 
		"Stamping"=>"pw-menu-customdiaries-stamping.php",
	);
