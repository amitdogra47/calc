...
if( !class_exists('diary_nicenames') ){
	class diary_nicenames{
		function diary_nicenames() { //constructor
...
?>		
			<div class="wrap">
<!-- edit heading -->
				<h3>Diary Nice names - used in the text of the quote - Edit Details</h3>
...
<?php	
		...
		function editpage() {
			...
			<div class="wrap">
<!-- edit heading	-->
			<h3>NICE NAMES - used in the quote</h3>
...
<?php			
	...
	} //END Class diary_nicenames
}  // end if class not exists
if( class_exists('diary_nicenames') )
	$diaryprices = new diary_nicenames();
?>