<?php
	...
	$pageheading = "Price Wizard - Help information";

	//This is Step3: enter the details for this tab
	// be sure to make the default tab the first in the list
	$headings=array(
		"Custom tables"=>"pw-menu-help-tables.php", 
		"Settings"=>"pw-menu-help-settings.php",
		"prettyPhoto settings"=>"pw-menu-help-prettyphoto-settings.php",
		"Notes"=>"pw-menu-help-notes.php",
